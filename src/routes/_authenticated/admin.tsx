      ...
      <section className="max-w-[1400px] mx-auto px-6 md:px-10 pt-16 pb-32">
        <div className="flex items-end justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link to="/admin/users" className="inline-flex items-center gap-2 px-6 py-3 border border-border uppercase tracking-[0.2em] text-[12px] hover:border-accent hover:text-accent transition-colors">
