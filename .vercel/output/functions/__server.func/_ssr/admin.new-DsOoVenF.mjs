...
import { P as ProductForm } from "./ProductForm-DWfLgZqr.mjs";
...
const SplitComponent = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground text-ui", children: [
  ...
  /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "max-w-3xl mx-auto px-6 pt-12 pb-32", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-6 text-display text-5xl", children: "Curate a new piece." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductForm, {}) })
  ] })
] });
export {
