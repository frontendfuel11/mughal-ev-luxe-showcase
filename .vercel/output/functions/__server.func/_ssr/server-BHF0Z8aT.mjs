...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BVy2Bvo5.mjs");
...
const manifest = {
  "2dbf334ca7bde700fa93ce47268e3db4f707c920da4c5f80915082d50b962d52": {
    ...
    importer: () => import("./admin-users.functions-FCJ_U2om.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Cwd_dM7j.mjs").then((n) => n.r),
    import("./start-R9Hh1kLQ.mjs"),
