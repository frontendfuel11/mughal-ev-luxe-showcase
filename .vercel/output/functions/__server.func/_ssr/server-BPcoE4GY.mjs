...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BPTGCM1u.mjs");
...
const manifest = {
  "2dbf334ca7bde700fa93ce47268e3db4f707c920da4c5f80915082d50b962d52": {
    functionName: "setUserAdmin_createServerFn_handler",
    importer: () => import("./admin-users.functions-B2LIwwKb.mjs")
  },
  "392804649a7ada2fdee0597dc35f31b4c801d9f28e2d2a70c1a0ca8d817cfe5f": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DCcxI6VO.mjs").then((n2) => n2.w),
    import("./start-CPpkOMJL.mjs"),
...
export {
  ...
  TSS_SERVER_FUNCTION as a4,
  createServerFn as a5,
  commonjsGlobal as a6,
  useMatchRoute as a7,
  getServerFnById as a8,
  getRequest as a9,
  server as aa,
  isNotFound as b,
  invariant as c,
