...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-wo-_gCmi.mjs");
...
const manifest = {
  "2dbf334ca7bde700fa93ce47268e3db4f707c920da4c5f80915082d50b962d52": {
    ...
    importer: () => import("./admin-users.functions-D_53V_Gq.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CSrtkTmY.mjs").then((n) => n.r),
    import("./start-eYZ2rI80.mjs"),
